...
contract JBStickyRewardReceiver {
    ...
    error JBStickyRewardReceiver_InvalidDistributor(IJBStickyDistributor distributor);
    ...
    IJBStickyDistributor public immutable DISTRIBUTOR;
    ...
    constructor(IJBStickyDistributor distributor, address stickyToken, uint256 groupId) {
