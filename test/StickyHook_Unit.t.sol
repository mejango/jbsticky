...
contract StickyHookUnitTest is Test {
    //*********************************************************************//
    // ----------------------- internal constants ------------------------ //
    //*********************************************************************//
    ...
    function test_afterCashOut_lifoSplitsNewestTrancheAndKeepsTimestamp() public {
        ...
        StickyTranche[] memory tranches = _hook.tranchesOf(_PROJECT_ID, _holder);
    ...
    function test_afterCashOut_revertsWhenCallerIsNotTerminal() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(StickyHook.StickyHook_CallerNotTerminal.selector, address(this)));
    ...
    function test_beforePay_gatesThirdPartyStakes() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(StickyHook.StickyHook_SenderNotTrusted.selector, _payer, _holder));
        ...
        vm.expectRevert(abi.encodeWithSelector(StickyHook.StickyHook_SenderNotTrusted.selector, friend, _holder));
        // forge-lint: disable-next-line(unused-return)
        _hook.beforePayRecordedWith(context);
    }
    ...
    function test_setGranters_revertsWhenCallerIsNotDeployer() public {
        address[] memory granters = new address[](1);
        granters[0] = _payer;
        vm.expectRevert(abi.encodeWithSelector(StickyHook.StickyHook_Unauthorized.selector, address(this), _deployer));
        _hook.setGrantersFor({projectId: _PROJECT_ID, granters: granters});
    }
