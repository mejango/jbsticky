...
contract JBStickyDeploymentHarness is JBStickyDeployment {
    ...
    function deployFor(JBStickyCoreDeployment memory core)
        external
    ...
    function loadCore(string memory root) external view returns (JBStickyCoreDeployment memory core) {
    ...
    function predict(JBStickyCoreDeployment memory core)
        external
        view
        returns (JBStickyDeploymentAddresses memory predicted)
    {
