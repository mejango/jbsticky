...
contract StickyTestLauncher is IJBPayerTracker {
    ...
    function launch(IStickyDeployer deployer, IERC20Metadata underlying) external payable returns (uint256 projectId) {
