...
contract StickyPricingToken is ERC20 {
    /// @notice The underlying token's immutable accounting precision.
    uint8 internal immutable _DECIMALS;

    /// @notice Initializes a token with the requested precision.
    ...
    /// @notice Creates underlying tokens for a regression participant.
    ...
    /// @notice Reports the token's configured accounting precision.
