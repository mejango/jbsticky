...
contract StickyBurnIntegrationTest is TestBaseWorkflow {
    ...
    function _exerciseBurns(bool soulbound) internal {
        ...
        StickyTranche[] memory tranches = _hook.tranchesOf(projectId, _holder);
