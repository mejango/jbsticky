...
import {IStickyAutoStick} from "../src/interfaces/IStickyAutoStick.sol";
...
// forge-lint: disable-next-line(multi-contract-file)
contract StickyAutoStickUnitTest is Test {
    //*********************************************************************//
    // ----------------------- internal constants ------------------------ //
    //*********************************************************************//
    ...
    StickyAutoStick internal _adapter;
    ...
    function test_beginVestingCoversEveryRequestedGroup() public {
        ...
        emit IStickyAutoStick.BeganAutoStickVesting(
            // forge-lint: disable-next-line(literal-instead-of-constant)
            _PROJECT_ID,
            _holder,
            address(_underlying),
    ...
    function test_beginVestingRequiresEnabledConfig() public {
        vm.expectRevert(abi.encodeWithSelector(StickyAutoStick.StickyAutoStick_Disabled.selector, _PROJECT_ID, _holder));
    ...
    function test_compoundPullsExactlyTheCollectedAmount() public {
        ...
        emit IStickyAutoStick.AutoStuck(_PROJECT_ID, _holder, address(_underlying), _group0(), 5e6, 5e18, _keeper);
        vm.prank(_keeper);
        (uint256 underlyingAmount, uint256 stickyTokenCount) = _adapter.compoundFor(_PROJECT_ID, _holder, _group0());
    ...
    function test_compoundRechecksActualDeliveredIssuanceBeforePull() public {
        ...
        vm.expectRevert(
            // forge-lint: disable-next-line(literal-instead-of-constant)
            abi.encodeWithSelector(StickyAutoStick.StickyAutoStick_ZeroIssuance.selector, _PROJECT_ID, 999_999)
        );
    ...
    function test_compoundRejectsPriceRoundingToZeroWith18Decimals() public {
        ...
        // forge-lint: disable-next-line(unused-return)
        (AutoStickStatus status,,,) = _adapter.statusOf(_PROJECT_ID, _holder, _group0());
        // forge-lint: disable-next-line(literal-instead-of-constant)
        assertEq(uint256(status), 7);
        vm.expectRevert(abi.encodeWithSelector(StickyAutoStick.StickyAutoStick_ZeroIssuance.selector, _PROJECT_ID, 1));
        // forge-lint: disable-next-line(unused-return)
        _adapter.compoundFor(_PROJECT_ID, _holder, _group0());
    }
    ...
    function test_compoundRejectsShortMintEvenIfTerminalIgnoresMinimum() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                // forge-lint: disable-next-line(literal-instead-of-constant)
                StickyAutoStick.StickyAutoStick_InsufficientStickyTokens.selector,
                // forge-lint: disable-next-line(literal-instead-of-constant)
                5e18 - 1,
                // forge-lint: disable-next-line(literal-instead-of-constant)
                5e18
    ...
    function test_compoundRevertsBelowMinimum() public {
        ...
        // forge-lint: disable-next-line(literal-instead-of-constant)
        vm.expectRevert(abi.encodeWithSelector(StickyAutoStick.StickyAutoStick_BelowMinimum.selector, 9e6, 10e6));
        // forge-lint: disable-next-line(unused-return)
        _adapter.compoundFor(_PROJECT_ID, _holder, _group0());
    }
    ...
    function test_compoundRevertsOnUnknownProject() public {
        // forge-lint: disable-next-line(literal-instead-of-constant)
        vm.mockCall(_deployer, abi.encodeCall(IStickyDeployer.stakedTokenOf, (99)), abi.encode(address(0)));
        // forge-lint: disable-next-line(literal-instead-of-constant)
        vm.mockCall(_tokens, abi.encodeCall(IJBTokens.tokenOf, (99)), abi.encode(address(0)));
        // forge-lint: disable-next-line(literal-instead-of-constant)
        vm.expectRevert(abi.encodeWithSelector(StickyAutoStick.StickyAutoStick_InvalidProject.selector, 99));
    ...
    function test_compoundRevertsWithoutAllowance() public {
        ...
        vm.expectRevert(
            // forge-lint: disable-next-line(literal-instead-of-constant)
            abi.encodeWithSelector(StickyAutoStick.StickyAutoStick_InsufficientAllowance.selector, 3e6, 5e6)
        );
        // forge-lint: disable-next-line(unused-return)
        _adapter.compoundFor(_PROJECT_ID, _holder, _group0());
    }
    ...
    function test_compoundRevertsWithoutTrust() public {
        ...
        _distributor.setCollectable(5e6);
        vm.expectRevert(
            abi.encodeWithSelector(StickyAutoStick.StickyAutoStick_NotTrusted.selector, _PROJECT_ID, _holder)
        );
        // forge-lint: disable-next-line(unused-return)
        _adapter.compoundFor(_PROJECT_ID, _holder, _group0());
    }
    ...
    function test_cooldownBlocksAndBoundarySucceeds() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(StickyAutoStick.StickyAutoStick_Cooldown.selector, availableAt));
        // forge-lint: disable-next-line(unused-return)
        _adapter.compoundFor(_PROJECT_ID, _holder, _group0());
    ...
    function test_emptyGroupIdsRevertOnEveryEntryPoint() public {
        ...
        bytes memory expected = abi.encodeWithSelector(StickyAutoStick.StickyAutoStick_EmptyGroupIds.selector, 0);
    ...
    function test_finiteAllowanceCompoundsUntilExhausted() public {
        ...
        _distributor.setCollectable(5e6);
        // forge-lint: disable-next-line(unused-return)
        (AutoStickStatus status,, uint256 allowance,) = _adapter.statusOf(_PROJECT_ID, _holder, _group0());
        assertEq(allowance, 0);
        assertEq(uint256(status), uint256(AutoStickStatus.InsufficientAllowance));
    }
    ...
    function test_groupIdsMustBeStrictlyAscendingOnEveryEntryPoint() public {
        ...
        bytes memory duplicatedError = abi.encodeWithSelector(
            // forge-lint: disable-next-line(literal-instead-of-constant)
            StickyAutoStick.StickyAutoStick_GroupIdsNotAscending.selector,
            // forge-lint: disable-next-line(literal-instead-of-constant)
            uint256(1000),
            // forge-lint: disable-next-line(literal-instead-of-constant)
            uint256(1000)
        ...
        // forge-lint: disable-next-line(literal-instead-of-constant,unused-return)
        (AutoStickStatus status,,,) = _adapter.statusOf(_PROJECT_ID, _holder, _groups(0, 1000));
    ...
    function test_minimumAppliesToTheCombinedTotal() public {
        ...
        // forge-lint: disable-next-line(unused-return)
        (AutoStickStatus status,,,) = _adapter.statusOf(_PROJECT_ID, _holder, _group0());
        assertEq(uint256(status), uint256(AutoStickStatus.BelowMinimum));
        // forge-lint: disable-next-line(literal-instead-of-constant)
        vm.expectRevert(abi.encodeWithSelector(StickyAutoStick.StickyAutoStick_BelowMinimum.selector, 3e6, 5e6));
        // forge-lint: disable-next-line(unused-return)
        _adapter.compoundFor(_PROJECT_ID, _holder, _group0());
    ...
    function test_multiGroupCompoundSumsEveryGroupAndCollectsEach() public {
        ...
        // forge-lint: disable-next-line(literal-instead-of-constant,unused-return)
        (AutoStickStatus status, uint256 collectable,,) = _adapter.statusOf(_PROJECT_ID, _holder, _groups(0, 2000));
        assertEq(uint256(status), uint256(AutoStickStatus.Ready));
        // forge-lint: disable-next-line(literal-instead-of-constant)
        ...
        vm.expectEmit();
        // forge-lint: disable-next-item(reentrancy-events)
        emit IStickyAutoStick.AutoStuck(
            // forge-lint: disable-next-line(literal-instead-of-constant)
            _PROJECT_ID,
            _holder,
            address(_underlying),
    ...
    function test_setConfigRevertsOnCooldownOutOfRange() public {
        vm.expectRevert(
            // forge-lint: disable-next-line(literal-instead-of-constant)
            abi.encodeWithSelector(StickyAutoStick.StickyAutoStick_InvalidCooldown.selector, 1 days - 1)
        );
        vm.prank(_holder);
        // forge-lint: disable-next-line(literal-instead-of-constant)
        ...
        vm.expectRevert(
            // forge-lint: disable-next-line(literal-instead-of-constant)
            abi.encodeWithSelector(StickyAutoStick.StickyAutoStick_InvalidCooldown.selector, 30 days + 1)
        );
        vm.prank(_holder);
        // forge-lint: disable-next-line(literal-instead-of-constant)
    ...
    function test_setConfigRevertsOnZeroMinimum() public {
        vm.expectRevert(abi.encodeWithSelector(StickyAutoStick.StickyAutoStick_InvalidMinimum.selector, 0));
        vm.prank(_holder);
        // forge-lint: disable-next-line(literal-instead-of-constant)
    ...
    function test_setConfigStoresAndEmits() public {
        vm.expectEmit();
        // forge-lint: disable-next-line(literal-instead-of-constant,reentrancy-events)
        emit IStickyAutoStick.SetAutoStick(_PROJECT_ID, _holder, true, 5e6, 2 days, _holder);
        vm.prank(_holder);
        // forge-lint: disable-next-line(literal-instead-of-constant)
    ...
    function test_statusOfRejectsGroupsTheDistributorCannotServe() public {
        ...
        // forge-lint: disable-next-line(literal-instead-of-constant)
        vm.expectRevert(abi.encodeWithSelector(StickyAutoStick.StickyAutoStick_InvalidGroupId.selector, 7));
        // forge-lint: disable-next-line(literal-instead-of-constant,unused-return)
        _adapter.statusOf(_PROJECT_ID, _holder, _groups(0, 7));

        // Every valid group encoding passes the check.
        // forge-lint: disable-next-line(literal-instead-of-constant,unused-return)
        (AutoStickStatus status,,,) = _adapter.statusOf(_PROJECT_ID, _holder, _groups(1000, 520_520));
        assertEq(uint256(status), uint256(AutoStickStatus.BelowMinimum));
    }
    ...
    function test_statusOfWalksTheLadder() public {
        ...
        vm.mockCall(_tokens, abi.encodeCall(IJBTokens.tokenOf, (99)), abi.encode(address(0)));
        // forge-lint: disable-next-line(literal-instead-of-constant,unused-return)
        (AutoStickStatus status,,,) = _adapter.statusOf(99, _holder, _group0());
        assertEq(uint256(status), uint256(AutoStickStatus.InvalidProject));

        // forge-lint: disable-next-line(unused-return)
        (status,,,) = _adapter.statusOf(_PROJECT_ID, _holder, _group0());
        assertEq(uint256(status), uint256(AutoStickStatus.Disabled));
        ...
        // forge-lint: disable-next-line(unused-return)
        (status,,,) = _adapter.statusOf(_PROJECT_ID, _holder, _group0());
        assertEq(uint256(status), uint256(AutoStickStatus.NotTrusted));
        ...
        (AutoStickStatus ready, uint256 collectable, uint256 allowance, uint256 nextCompoundAt) =
            _adapter.statusOf(_PROJECT_ID, _holder, _group0());
        assertEq(uint256(ready), uint256(AutoStickStatus.Ready));
        // forge-lint: disable-next-line(literal-instead-of-constant)
        ...
        assertEq(uint256(status), uint256(AutoStickStatus.Cooldown));
        // forge-lint: disable-next-line(literal-instead-of-constant)
    ...
    function test_stickRewardsRevertsWithNothingClaimable() public {
        ...
        // forge-lint: disable-next-line(unused-return)
        _underlying.approve(address(_adapter), type(uint256).max);
        vm.expectRevert(abi.encodeWithSelector(StickyAutoStick.StickyAutoStick_BelowMinimum.selector, 0, 1));
        vm.prank(_holder);
        // forge-lint: disable-next-line(unused-return)
        _adapter.stickRewardsFor(_PROJECT_ID, _group0());
    }
    ...
    function test_stickRewardsUsesCallerAsHolder() public {
        ...
        vm.mockCall(
            _hook,
            abi.encodeCall(IStickyHook.isTrustedSenderOf, (_PROJECT_ID, _keeper, address(_adapter))),
            abi.encode(true)
        );
        vm.prank(_keeper);
    ...
    function test_statusOrdinalsRemainCompatibleWithClients() public pure {
        assertEq(uint256(AutoStickStatus.Ready), 0);
        assertEq(uint256(AutoStickStatus.Disabled), 1);
        assertEq(uint256(AutoStickStatus.InvalidProject), 2);
        assertEq(uint256(AutoStickStatus.Cooldown), 3);
        assertEq(uint256(AutoStickStatus.BelowMinimum), 4);
        assertEq(uint256(AutoStickStatus.NotTrusted), 5);
        // forge-lint: disable-next-line(literal-instead-of-constant)
        assertEq(uint256(AutoStickStatus.InsufficientAllowance), 6);
        // forge-lint: disable-next-line(literal-instead-of-constant)
        assertEq(uint256(AutoStickStatus.ZeroIssuance), 7);
    }
    ...
    function _mockGranter(bool granter) internal {
        vm.mockCall(
            _hook, abi.encodeCall(IStickyHook.isGranterOf, (_PROJECT_ID, address(_adapter))), abi.encode(granter)
        );
    }
    ...
    function _mockTrust(bool trusted) internal {
        vm.mockCall(
            _hook,
            abi.encodeCall(IStickyHook.isTrustedSenderOf, (_PROJECT_ID, _holder, address(_adapter))),
            abi.encode(trusted)
        );
    }
    ...
    function _setUpWithDecimals(uint8 decimals) internal {
        ...
        vm.mockCall(_deployer, abi.encodeCall(IStickyDeployer.stakedTokenOf, (_PROJECT_ID)), abi.encode(_underlying));
