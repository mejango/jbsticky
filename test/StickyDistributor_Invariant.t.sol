...
/// `StickyDistributorInvariantTest` checks its invariants against.
...
// forge-lint: disable-next-line(multi-contract-file)
contract StickyDistributorHandler is Test {
    //*********************************************************************//
    // ------------------------------ structs ---------------------------- //
    //*********************************************************************//
    ...
    StickyDistributor public immutable DISTRIBUTOR;
    ...
    constructor(
        ...
        StickyDistributor rewardDistributor,
    ...
    {
        // forge-lint: disable-next-line(calls-loop)
        StickyTranche[] memory tranches = HOOK.tranchesOf(targetProjectId, actor);
        // forge-lint: disable-next-line(uninitialized-local)
...
// forge-lint: disable-next-line(multi-contract-file)
contract StickyDistributorInvariantTest is TestBaseWorkflow {
    //*********************************************************************//
    // ----------------------- internal constants ------------------------ //
    //*********************************************************************//
    ...
    StickyDistributorHandler _handler;
    ...
    function setUp() public override {
        ...
        _handler = new StickyDistributorHandler({
            stickyHook: _hook,
